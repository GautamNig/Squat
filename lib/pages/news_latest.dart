...
class _NewsLatestState extends State<NewsLatest> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        Scaffold(
          appBar: header(context, titleText: 'Latest News'),
          body: (nYTimesLatestWorldNews != null && nYTimesLatestWorldNews!.results != null)
                      ? ListView.builder(
                          itemCount:
                              nYTimesLatestWorldNews!.results?.length,

                          // display each item of the product list
                          itemBuilder: (context, index) {
                            return nYTimesLatestWorldNews!
                                .results![index].multimedia != null ? nYTimesLatestWorldNews!
        ...
        }, icon: const FaIcon(FontAwesomeIcons.newspaper, color: Colors.white,)),
