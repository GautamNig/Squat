...
class CandleSeriesRenderer extends XyDataSeriesRenderer {
  ...
  ChartSegment _createSegments(CartesianChartPoint<dynamic> currentPoint,
    ...
    if (_segment != null) {
      ...
      _segment.currentSegmentIndex = currentPoint.overallDataPointIndex;
...
class CandlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (seriesRendererDetails.visible! == true) {
      ...
      final List<CartesianChartPoint<dynamic>> dataPoint =
          seriesRendererDetails.visibleDataPoints!.isEmpty
              ? dataPoints
              : seriesRendererDetails.visibleDataPoints!;
      for (int pointIndex = 0; pointIndex < dataPoint.length; pointIndex++) {
        point = dataPoint[pointIndex];
